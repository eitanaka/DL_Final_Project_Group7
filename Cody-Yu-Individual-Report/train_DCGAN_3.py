...
Purpose: Fine-Tuning DCGAN with LeakyReLu with 0.2 on G and D

LeakyReLU is an advanced ReLU function which allows the pass of negative cases with a small value
In practice, LeakyReLU has a signiﬁcant eﬀect on stablizing GAN training (
"""
...
def save_best_model(netG, netD, epoch):
    torch.save(netG.state_dict(), os.path.join(MODEL_DIR, 'DCGAN_netG_c4.pth'))
    torch.save(netD.state_dict(), os.path.join(MODEL_DIR, 'DCGAN_netD_c4.pth'))
