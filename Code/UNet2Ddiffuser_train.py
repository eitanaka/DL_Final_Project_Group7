...
Author: Jeffrey
Date: Nov 27, 2023
Purpose: Image 2 Image generation w/ UNet2D diffuser model
References:
...
config.dataset_name = "Alanox/stanford-dogs" #Someone hosted the stanford-dogs dataset on HF
dataset = load_dataset(config.dataset_name, split="full")
